...
/**
 * The main app. This defines the routes for all of the pages.
 */
class App extends Component {
  /**
   * Defines the routes for the entire app.
   * @component
   * @return {component}
   */
  render() {
        ...
        <Routes>
          <Route>
            ...
            <Route path="/spectate/:id"
              element={<ChessPage spectating={true} />}
            />
            <Route path="/chess"
              element={<ProtectedRoute component={<ChessPage/>} />}
            />
            <Route path="/profile"
